...
# g. Create a vector from (c) that repeats the third element of (c) three times, the sixth element four times, and the last ele- ment once.


# h. Create a new vector as a copy of (e) by assigning (e) as is to a newly named object. 
#    Using this new copy of (e), overwrite the first, the fifth to the seventh (inclusive), 
